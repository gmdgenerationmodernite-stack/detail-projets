...
TEL;TYPE=CELL:+224612282644
EMAIL:directoiredecampagne@gmail.com
ADR;TYPE=WORK:Kaloum Conakry, Conakry, Guinée
URL:#
END:VCARD`;
...
function shareCard(){
  if (navigator.share){
    navigator.share({ title:'GMD', text:'Carte de visite numérique', url:window.location.href })
      .catch(()=>{});
  } else {
